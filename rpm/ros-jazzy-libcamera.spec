...
%define __spec_install_post \
    ...
    %{__arch_install_post} \
    %{__os_install_post} \
    %{_builddir}/%{name}-%{version}/src/ipa/ipa-sign-install.sh %{_builddir}/%{name}-%{version}/%{_vpath_builddir}/src/ipa-priv-key.pem %{buildroot}//opt/ros/jazzy/lib/libcamera/ipa_*.so \
%{nil}
...
%changelog
* Sun Jan 05 2025 Christian Rauch <Rauch.Christian@gmx.de> - 0.4.0-1
- Autogenerated by Bloom

* Tue Sep 24 2024 Christian Rauch <Rauch.Christian@gmx.de> - 0.3.2-1
- Autogenerated by Bloom

* Tue Sep 03 2024 Christian Rauch <Rauch.Christian@gmx.de> - 0.3.1-4
- Autogenerated by Bloom
